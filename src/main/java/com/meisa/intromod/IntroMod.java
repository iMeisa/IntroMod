package com.meisa.intromod;

import com.meisa.intromod.block.ModBlocks;
import com.meisa.intromod.events.ModEvents;
import com.meisa.intromod.item.ModItems;
import com.meisa.intromod.item.ModTools;
...
//        LOGGER.info("Got game settings {}", event.getMinecraftSupplier().get().options);
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("intromod", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
