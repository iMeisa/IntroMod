...
public class RedwoodTree extends Tree {
    ...
    private static final int LEAF_OFFSET = 3;
    private static final int LEAF_HEIGHT = 4;
    ...
    public static final BaseTreeFeatureConfig REDWOOD_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(
            ...
            new BlobFoliagePlacer(FeatureSpread.create(LEAF_RADIUS),
                    FeatureSpread.create(LEAF_OFFSET),
                    LEAF_HEIGHT),
